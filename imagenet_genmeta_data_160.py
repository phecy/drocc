...
batch_meta['num_vis'] = 128*128*3 #49152

tar_fn_list = '/mnt/exthdd/imagenet_data/imagenet_batches/imagenet_tr/tar_files.txt' 

cn = 0
for line in open(tar_fn_list, 'r'):
	line = line.strip('\n')
	if  cn == 0:
		mean_im = GetMeanImage(line, 160, 4)
	else:
		mean_im = mean_im + GetMeanImage(line, 160, 4)
	cn = cn + 1
	print cn
mean_im = mean_im/cn
