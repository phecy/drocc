python convnet.py -f ./imagenet_savemodels/half_imagenet/ConvNet__2013-08-12_00.35.42 --save-path=/imagenet_savemodels/half_imagenet/ --epochs=300000 1>imagenet_savemodels/half_imagenet/half_256_cont.log 2>imagenet_savemodels/half_imagenet/half_256_cont.err 
